...
km.loginResult()
print "Km-Login Success\n\n=====[PrillyBot_JANGAN SONGONG PAKE SCRIPT ORANG!!!]====="
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : Vipro\nContact Me : 🐝line://ti/p/~-arsyila03🐝",
		...
		if msg.from_ in admin:
		    ...
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        ...
                        gs = kk.getGroup(msg.to)
                        gs = kc.getGroup(msg.to)
                        ki.sendText(msg.to,"Croot yuu saayy~")
                        kc.sendText(msg.to,"Crooottt~")
                        targets = []
                        for g in gs.members:
