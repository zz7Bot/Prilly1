...
vipro = zz7.LINE()
vipro.login(token='EvRlPSUaaM1p4oy6lBd2.KJyizgzkdten8ali1aJMqG.G+rS/gHZO/mLvOsXCplK3vmP4v3QZPc0KgXDXBpNKx0=')
vipro.loginResult()

print "PrillyBot-Ciee Ciee Login\n\n=====[AWAS JANGAN SONGONG LOE]====="
reload(sys)
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
"""
vip="u92360864664a0d310df002c8d408e642"
...
admin=["u92360864664a0d310df002c8d408e642"]
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
            ...
            elif "Prilly" == msg.text:
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        print "Kick all member"
                        _name = msg.text.replace("Prilly","")
                        gs = vipro.getGroup(msg.to)
                        vipro.sendText(msg.to,"Croot yuu...Croott")
                        targets = []
                        for g in gs.members:
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["Team","My PrillyBot Team"]:
                   msg.contentType = 13
	           vipro.sendText(msg.to,teamMessage)               
                   fams1 = "u92360864664a0d310df002c8d408e642"
		   fams3 = "u92360864664a0d310df002c8d408e642"
                   fams4 = "u92360864664a0d310df002c8d408e642"
                   fams5 = "u92360864664a0d310df002c8d408e642"
                   fams6 = "u92360864664a0d310df002c8d408e642"
		   fams7 = "u92360864664a0d310df002c8d408e642"
                   fams8 = "u92360864664a0d310df002c8d408e642"
		   fams17 = "u92360864664a0d310df002c8d408e642"
		   fams18 = "u92360864664a0d310df002c8d408e642"
		   ...
		   msg.contentMetadata = {'mid': fams18}
                   random.choice(KAC).sendMessage(msg)
		   random.choice(KAC).sendText(msg.to,"💋LOE SONGONG BERARTI LOE SIAP ANCUR💋SALAM JARI TENGAH BUAT PECUNDANG💋DARI PRILLY_BOT")
